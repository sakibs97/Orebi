...
const Contact = () => {
    return (
        <Container>
            ...
            <div className="my-[30px]">
                <iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d29199.169254540942!2d90.3842619!3d23.8222914!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sbd!4v1719250101699!5m2!1sen!2sbd" className="w-full h-[400px]"></iframe>
            </div>
        </Container>
    )
}
